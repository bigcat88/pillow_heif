...
- Type checkers (`Pyright`/`Pylance`, `mypy --strict`) reported the names imported from `pillow_heif` as not exported since the `py.typed` marker was added in `1.7.0`. #490 Thanks to @BetoFernandez123
